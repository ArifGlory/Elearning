<?= $this->session->flashdata('message'); ?><div class="col-md-12">
                            ...
                            <div class="p-5">
                                          ...
                                          <div class="col-md-12 mr-2">
                                            ...
                                            <div class="mb-1 text-xs mt-2"><?= $kom['komentar_forum']?></div>
                                              <div class="text-right">
                                                  <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Ingin Menghapus Komentar ini?');" href="<?= site_url('siswa/delete_komentar/'.$kom['id_komentar_forum'])?>">Hapus</a>
                                              </div>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              <?php endforeach;?>
                                ...
                                <form class="user" method="post" enctype="multipart/form-data">
                                    ...
                                    <button name="submit_komentar_siswa" type="submit" class="btn btn-primary btn-user btn-block">
                                        Komentar
                                    </button>
                                </form>
                            </div>
