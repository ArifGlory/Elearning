                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="post" enctype="multipart/form-data">
                                  <input type="hidden" name="id_absensi" value="<?php echo $this->uri->segment(3)?>">
                                    ...
                                    <div class="form-group">
                                      <textarea id="keterangan_absensi" name="keterangan_absensi" class="form-control" placeholder="Keterangan (Opsional)"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Surat Izin (Optional)</label>
                                        <input type="file" name="file" class="form-control">
                                    </div>
                                    <button name="tambah_absensi_siswa" type="submit" class="btn btn-primary btn-user btn-block">
                                        Submit
                                    </button>
                                </form>
                            </div>
