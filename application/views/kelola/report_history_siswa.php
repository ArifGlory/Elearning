                  ...
                  <div class="form-group">
                      <select class="form-control" onchange="javascript:handleSelect(this)">
                          ...
                          <?php foreach($tahun as $tah):?>
                              <option value="<?php echo site_url('kelola/report_siswa_tahun/').$tah['id_tahun']."/".$id_siswa ?>/"> <?= $tah['tahun']?> </option>
                          <?php endforeach;?>
                      </select>
                  </div>
              </div>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
          <div class="row">
           ...
           <!-- <div class="col-md-6"><h6>Tahun Pelajaran : <?/*= $user['tahun']*/?></h6></div>-->
